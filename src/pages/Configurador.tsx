...
export default function Configurador() {
  ...
  return (
    <div className="container space-y-4 py-4 md:pb-28 md:pt-6">
      ...
      <aside className={`fixed inset-x-0 bottom-0 z-30 hidden border-t border-primary/40 bg-card/95 shadow-[0_-8px_24px_hsl(var(--background)/0.45)] backdrop-blur md:block lg:left-[5.5rem] ${abaCadastro === "checklist" ? "md:hidden" : ""}`} aria-label="Total congelado do orçamento">
